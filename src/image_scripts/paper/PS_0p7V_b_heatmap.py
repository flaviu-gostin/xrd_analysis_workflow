"""Create powder diffraction heatmap figure for PS at 0.7 V

Run with: python PS_0p7V_b_heatmap.py
...
measured_patterns_dir = "../../../results/intermediate/integrated_1D/PS_0p7V_b"
reference_peaks_dir = "../../../results/intermediate/peaks_references"
figure_fn = "../../../results/final/PS_0p7V_b_heatmap.svg"
